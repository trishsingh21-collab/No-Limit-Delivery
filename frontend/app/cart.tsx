...
const styles = StyleSheet.create({
  ...
  restaurantHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: Spacing.md, backgroundColor: Colors.white },
  ...
  itemImage: { width: 50, height: 50, borderRadius: BorderRadius.md, backgroundColor: Colors.white, marginRight: Spacing.sm },
  itemInfo: { flex: 1 },
  ...
  summary: { margin: Spacing.xl, padding: Spacing.md, backgroundColor: Colors.white, borderRadius: BorderRadius.lg },
