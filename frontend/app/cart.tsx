...
const styles = StyleSheet.create({
  ...
  restaurantHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: Spacing.md, backgroundColor: Colors.paleGray },
  ...
  itemImage: { width: 50, height: 50, borderRadius: BorderRadius.md, backgroundColor: Colors.paleGray, marginRight: Spacing.sm },
  itemInfo: { flex: 1 },
  itemName: { ...Typography.bodySmall, color: Colors.black, marginBottom: 2 },
  ...
  summary: { margin: Spacing.xl, padding: Spacing.md, backgroundColor: Colors.paleGray, borderRadius: BorderRadius.lg },
